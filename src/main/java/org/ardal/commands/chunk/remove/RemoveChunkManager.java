...
public class RemoveChunkManager extends ArdalCmdNode implements ArdalCmd {
    private static final String CMD_NAME = "remove";

    public RemoveChunkManager(){
        super(CMD_NAME);

        this.registerCmd(new RemoveChunkInGroupCmd());
        this.registerCmd(new RemoveChunkGroup());
    }
